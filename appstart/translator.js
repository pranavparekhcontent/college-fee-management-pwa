...
export const Translator = (() => {
   ...
   * threshold: defaults to 0.6 (60%) for small header matches.
   */
  function identifySheet(rows, requiredConcepts, threshold = 0.6) {
    ...
    // Heuristic match: check if match percentage meets or exceeds threshold
    return (matches / Object.keys(requiredConcepts).length) >= threshold;
  }
