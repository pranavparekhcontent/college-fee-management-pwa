...
export const SchemaLearner = (() => {
  ...
  const CONCEPTS = {
    STUDENT_RECORD: {
      id:                 ['id', 'roll no', 'roll', 'no', 'student id'],
      name:               ['name', 'student name', 'full name', 'fullname'],
      serial_no:          ['serial no', 'serial_no', 'admission no', 'admission number'],
      current_class:      ['class', 'current_class', 'program', 'year'],
      category:           ['category', 'caste'],
      fee_applicable:     ['fee applicable', 'fee_applicable', 'applicable fee']
    },
    SUBJECT_RECORD: {
